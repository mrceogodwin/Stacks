...
TEXT = """Stacks is a production house for web apps, plugins, and tools, built in Nigeria for companies and businesses that need software that actually works.

This is the home of Stacks. Two doors sit on the first screen. Explore Apps opens the gallery of live products. Explore tools opens a library of more than five hundred tools for writing, images, video, marketing, and SEO.
...
The workspace is where the work finishes. Each tool has its own fields. Fill them in, then run. Text downloads as PDF, TXT, HTML, or a Word document. Images download as pictures. Video downloads as MP4. Copy the result, share it, save it, or regenerate another version. Eight actions on every tool.
...
async def main() -> None:
    ...
    (ROOT / "voice-v8.timestamps.json").write_text(
