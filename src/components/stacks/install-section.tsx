  ...
  return (
    <section id="install" className="px-4 pb-10 sm:px-6">
      <div className="mx-auto w-full max-w-6xl">
        <div className="install-panel rounded-[1.6rem] border border-line px-5 py-10 sm:px-10">
          ...
          <p className="mt-3 max-w-lg text-muted">
            One icon. Apps, 500+ tools, Daily Tools, and Premium. Works on iPhone and Android.
          </p>
